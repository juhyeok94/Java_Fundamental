...
public class MemberManagementDemo {
	...
	public String input(String msg) {
		...
		return sc.next(); //키보드에서 입력한 데이터를 반환 (검정글자)
	}
	
	public void run(String inputData) {
		if(inputData.contentEquals("1")) {
			insert();
	...
	public void insert() {
		...
		print();
		String inputData = input("번호를 입력하세요>");
		run(inputData);
	}
	
	//1. 수정할 아이디를 입력받는다.
	//2. ArrayList에 있는 고객정보에서 수정할 ㅏ이디를 찾아서 있으면 수정하 이름을 입력받고, ArrayList에 고객정보를 수정한다.
	//   만약, 수정할 아이디가 없으면 "수정할 아이디가 없습니다." 메세지를 출력한다.
	//3. ArrayList에 있는 모든 고객을 출력한다.
	//4. Print() 메서드 호출
	//5. 번호를 선택하세요> 메서지를 출력한 후 키보드 입력을 받게 한다.
	...
	//1. 삭제할 아이디를 입력받는다.
	//2. ArrayList의 Member 객체중에서 삭제할 아이들ㄹ 찾아 있으면 삭제하고 없으면 "삭제할 아이디가 없습니다." 메세지를 출력한다.
	//3. ArrayList에 있는 모든 고객을 출력한다.
	//4. Print() 메서드 호출
	//5. 번호를 선택하세요> 메서지를 출력한 후 키보드 입력을 받게 한다.
	public void delete() {
	...
	//1. 검색할 아이디를 입력 받는다.
	//2. ArrayListdp Member 객체중에서 검색할 아이들르 찾아서 있으면 출력하고 없으면 "검색된 결과가 없습니다." 메세지 출력
	//3. ArrayList에 있는 모든 고객을 출력한다.
	//4. Print() 메서드 호출
	//5. 번호를 선택하세요> 메서지를 출력한 후 키보드 입력을 받게 한다.
	public void search() {
